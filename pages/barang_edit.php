    ...
    <div class="card-body">
        <form action="<?php echo BASE_URL; ?>pages/barang_action.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="barcode" name="barcode" value="<?php echo htmlspecialchars($barang['barcode']); ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="idkategori" name="idkategori" required>
                    ...
                    <?php foreach ($kategories as $kategori): ?>
                        <option value="<?php echo $kategori['idkategori']; ?>" <?php echo ($kategori['idkategori'] == $barang['idkategori']) ? 'selected' : ''; ?>>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="harga_beli" name="harga_beli" value="<?php echo htmlspecialchars($barang['harga_beli']); ?>" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="harga_jual" class="form-label">Harga Jual</label>
                        <input type="number" class="form-control" id="harga_jual" name="harga_jual" value="<?php echo htmlspecialchars($barang['harga_jual']); ?>" required>
                    </div>
                </div>
            </div>
            <div class="mb-3">
